...
def viz_predictions_helper(
        ...
        viz_seq_id: Union[None, List[int]], afl
) -> None:
    ...
    for seq_id in seq_ids:
        ...
        input_trajectory = (
            ...
            [:args.obs_len, [FEATURE_FORMAT["X"], FEATURE_FORMAT["Y"]]].astype(
                "float"))
        output_trajectories = forecasted_trajectories[str(seq_id)]

        city_name = curr_features_df["FEATURES"].values[0][
            0, FEATURE_FORMAT["CITY_NAME"]]
        candidate_centerlines = avm.get_candidate_centerlines_for_traj(input_trajectory,city_name, viz=False)
...
if __name__ == "__main__":
    ...
    root_dir = '/home/mhatfalv/argoverse-forecasting/val_data/test/data'
